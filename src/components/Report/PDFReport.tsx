            ...
            <Document>
                <Page size="A4" style={styles.page}>
                    <View style={styles.header}>
                        <Text style={styles.title}>{language === 'ml' ? 'വ്യക്തിത്വ ഫലം' : 'Personality Report'}</Text>
                        <Text style={styles.subtitle}>MBTI Assessment Analysis</Text>
                    </View>

                    <View style={styles.section}>
                        <Text style={{ fontSize: 40, fontWeight: 'bold', color: '#4338ca', textAlign: 'center', marginVertical: 20 }}>
                            {results.mbti.type}
                        </Text>
                        <Text style={{ fontSize: 14, textAlign: 'center', marginBottom: 20, color: '#374151' }}>
                            {results.mbti.details.name}
                        </Text>
                        ...
                        <View style={{ marginTop: 5 }}>
                            {(results.mbti.details.careers || []).map((career, idx) => (
                                <View key={idx} style={styles.row}>
                                    <Text style={[styles.text, styles.col1]}>{career}</Text>
                                </View>
                            ))}
                        </View>
                    </View>
