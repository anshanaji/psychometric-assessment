    ...
    return (
        <div className={styles.section}>
            <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
                <h2 className={styles.sectionTitle}>Possible Career Paths</h2>
                <div style={{ width: '60px', height: '4px', background: '#e2e8f0', margin: '1rem auto', borderRadius: '2px' }}></div>
                <p style={{ color: '#64748b', maxWidth: '600px', margin: '0 auto', lineHeight: '1.6' }}>
                    We've screened over 1,000 careers to find the ones that match your unique personality and code.
                    <span style={{ display: 'block', marginTop: '0.5rem', fontWeight: 500, color: '#4f46e5' }}>
                        Top matches are highlighted in green.
                    </span>
                </p>
            </div>
            ...
            {/* Legend */}
            <div style={{ display: 'flex', justifyContent: 'center', gap: '2rem', marginTop: '3rem', fontSize: '0.9rem', color: '#64748b' }}>
